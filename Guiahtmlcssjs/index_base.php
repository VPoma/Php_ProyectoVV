...
<body>
    <header class="clearfix">
        <div class="logo col-md-3">
            <h2 class="logo-text">INFUSION</h2>
        </div>
        <nav class="clearfix">
            <ul class="clearfix">
    ...
    <div class="banner">
        <ul>
            <li style="background-image: url('assets/img/01.jpg');">
                <div class="container">
                    <div class="row">
            ...
            <li style="background-image: url('assets/img/02.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="hero-title">
    ...
    <div class="container carousel">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="ca-hover">
                    <div class="carousel-img">
                        <img src="assets/img/c01.jpg" alt="Carousel Img">
                    </div>
            ...
            <div class="col-md-3">
                <div class="ca-hover">
                    <div class="carousel-img">
                        <img src="assets/img/c02.jpg" alt="Carousel Img">
                    </div>
            ...
            <div class="col-md-3">
                <div class="ca-hover">
                    <div class="carousel-img">
                        <img src="assets/img/c03.jpg" alt="Carousel Img">
                    </div>
            ...
            <div class="col-md-3">
                <div class="ca-hover">
                    <div class="carousel-img">
                        <img src="assets/img/c04.jpg" alt="Carousel Img">
                    </div>
    ...
    <div class="container-fluid container-articles">
        <div class="row articles">
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/01.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/02.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/03.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/04.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/05.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/06.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
        </div>
        <div class="row articles">
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/07.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/08.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/09.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/10.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/11.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
            <div class="col-md-2 article-img">
                <a href="#"><img src="assets/img/articles/12.jpg" alt=""></a>
                <div class="article-overlay"></div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 laptop-placeholder">
                    <div class="slideshow">
                        ...
                        <figure><img alt="" src="assets/img/slider/slide-02.png" /></figure>
                        <figure><img alt="" src="assets/img/slider/slide-01.png" /></figure>
                        <figure><img alt="" src="assets/img/slider/slide-02.png" /></figure>
